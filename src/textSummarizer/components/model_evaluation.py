...
from textSummarizer.config.configuration import DataEvaluationConfig
...
class ModelEvaluation:
    ...
    def calculate_metric_on_ds(self, dataset, metric, model, tokenizer,
    ...
    def evaluate(self):
        ...
        score = self.calculate_metric_on_ds(
